  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.socialNetworksBox}>
        <a href='https://www.instagram.com/lascalidosasburger/' target='_blank'>
      ...
      {!hideLocation ? (
        <p>
          <a href='https://goo.gl/maps/SsPjhVtvM9vRK9Kd7' target='_blank'>
            <MdOutlineLocationOn />
      ...
      {!hidePhone ? (
        <p>
          <a href='https://wa.me/19735101954' target='_blank'>
